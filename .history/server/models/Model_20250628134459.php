...
{
    // Database table name (set in child class)
    protected static string $table;
    // Primary key column name (default 'id')
    protected static string $primary_key = 'id';
    // Shared mysqli connection
    protected static mysqli $connection;
    // Instance attributes holder
    protected array $attributes;

    /**
     * Set the mysqli connection for all models
     */
    ...
    /**
     * Constructor: store row data in attributes
     */
    ...
    /**
     * Create a new record and return its model instance
     */
    ...
    public function update(): bool
    {
        ...
        // Bind types including the primary key at the end
        $types  = '';
        $values = [];
        foreach ($data as $value) {
            if (is_int($value)) {
        ...
        $types      .= 'i'; // primary key is always integer
        $values[]    = $id;
