...
class User extends Model
{
    ...
    protected function syncToAttributes(): void
    {
        ...
        $this->attributes['first_name'] = $this->firstName;
        $this->attributes['last_name'] = $this->lastName;
        $this->attributes['email'] = $this->email;
        $this->attributes['mobile'] = $this->mobile;
        $this->attributes['password_hash'] = $this->passwordHash;
        $this->attributes['date_of_birth'] = $this->dateOfBirth;
    ...
    // $user->getFirstName() - property-based (type-safe)
    // $user->get('first_name') - array-based (flexible)
}
