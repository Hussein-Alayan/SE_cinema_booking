...
abstract class Model
{
    ...
    //Set a value in the attributes array by column name
    ...
    public static function find(int $id): ?static
    {
        ...
        $sql = sprintf(
            'SELECT * FROM %s WHERE %s = ?', //for column name 
            static::$table,
            static::$primary_key
        );
    ...
    public function update(): bool
    {
        ...
        unset($data[static::$primary_key]); //so we dont set the primary

        $columns   = array_keys($data);
        $setClause = implode( //  converts an array of column names into a string like "column1 = ?, column2 = ?" for the SQL statement.
            ', ',
